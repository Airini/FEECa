...
t3 = Fform 2 $ readjustLs [([2,1],813.0),([1,0],351.0),([1,2],903.0),([3,1],816.0),([2,0],180.0),([0,0],314.0),([0,3],373.0),([0,1],-988.0),([0,3],-284.0),([1,3],301.0),([1,3],-161.0),([0,0],842.0),([0,2],407.0),([1,3],-959.0),([1,3],954.0),([0,1],639.0)]
t4 = Fform 2 $ readjustLs [([2,1],981.0),([3,0],150.0),([1,0],692.0),([2,1],674.0),([3,0],-354.0),([3,3],927.0),([1,3],-869.0),([0,3],238.0),([3,1],575.0),([0,3],433.0),([2,0],359.0),([2,1],554.0),([2,1],259.0),([2,3],16.0),([3,0],923.0),([3,3],936.0)]
...
a11 = Fform 2  [(1.0,[2,3]),(2.0,[2,2]),(-1.0,[3,2])]
a12 = Fform 2  [(0.0,[2,2]),(2.0,[2,3]),(-3.0,[4,4])]
...
b11 = Fform 2 [(4.0,[4,2]),(3.0,[1,1]),(-2.0,[3,3]),(-4.0,[2,3])]
b12 = Fform 2 [(-3.0,[2,1]),(4.0,[2,4]),(-2.0,[2,2]),(4.0,[2,1])]
