...
t1 = Form 1 3 $ map (pairM id (map (+1))) [(2.0,[2]),(-47.0,[0]),(-35.0,[2]),(-50.0,[1]),(-3.0,[1]),(29.0,[0]),(-11.0,[1]),(-17.0,[1]),(-6.0,[0]),(30.0,[1])]
t2 = Form 1 3 $ readjustLs [([2],-17.0),([2],53.0),([0],-36.0),([1],-51.0),([2],-47.0),([1],-28.0),([0],58.0),([0],-48.0),([0],-4.0),([1],20.0)]
b1 = Vex 3 [723.0,255.0,-109.0]
b2 = Vex 3 [-340.0,-1018.0,297.0]
aux1 d1 d2 = refine dxV (d1 /\ d2)

t3 = Form 2 4 $ readjustLs [([2,1],813.0),([1,0],351.0),([1,2],903.0),([3,1],816.0),([2,0],180.0),([0,0],314.0),([0,3],373.0),([0,1],-988.0),([0,3],-284.0),([1,3],301.0),([1,3],-161.0),([0,0],842.0),([0,2],407.0),([1,3],-959.0),([1,3],954.0),([0,1],639.0)]
t4 = Form 2 4 $ readjustLs [([2,1],981.0),([3,0],150.0),([1,0],692.0),([2,1],674.0),([3,0],-354.0),([3,3],927.0),([1,3],-869.0),([0,3],238.0),([3,1],575.0),([0,3],433.0),([2,0],359.0),([2,1],554.0),([2,1],259.0),([2,3],16.0),([3,0],923.0),([3,3],936.0)]
...
a11 = Form 2 4 [(1.0,[2,3]),(2.0,[2,2]),(-1.0,[3,2])]
a12 = Form 2 4 [(0.0,[2,2]),(2.0,[2,3]),(-3.0,[4,4])]
...
b11 = Form 2 4 [(4.0,[4,2]),(3.0,[1,1]),(-2.0,[3,3]),(-4.0,[2,3])]
b12 = Form 2 4 [(-3.0,[2,1]),(4.0,[2,4]),(-2.0,[2,2]),(4.0,[2,1])]
